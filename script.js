...
const animate = () => {
    ...
    if(stat){
    u.writeT("Mitsi, eres la chispa que enciende mi alma,",0.5*W,0.80*H);
u.writeT("Un amor intenso que late sin control.",0.5*W,0.85*H);
u.writeT("En tus ojos brilla una luz que me guía,",0.5*W,0.9*H);
    u.writeT("y en tus brazos encuentro mi refugio.",0.5*W,0.95*H);}
...
const init = () => {
    ...
    turn=0;
    stat=(window.confirm("Quieres leer un poema?"));
    ropes=[];
